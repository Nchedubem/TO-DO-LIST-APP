  ...
  function loadAddTaskPage() {
    content.innerHTML = `
      <h3>Daily Mega Prompt for You</h3>
      <form id="taskForm">
      ...
      <p>Task Count: <span id="taskCount">0</span></p>
    `;
          ...
          <div class="contact-form">
              ...
              <div class="Social-Media">
                ...
                <div class="social-icons">
                   <a href="https://www.facebook.com/Iamchidubemnweke/"><i class="fab fa-facebook"></i></a>
                   <a href="https://www.linkedin.com/in/Iamchidubemnweke/"><i class="fab fa-linkedin"></i></a>
                   <a href="https://www.x.com/iam_chidubemnweke /"><i class="fab fa-twitter"></i></a>
                   <a href="https://www.instagram.com/Iamchidubemnweke/"><i class="fab fa-instagram"></i></a>
                </div>
              </div>
          </div>
        </div>`;
